  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}_clip)`}>
        {/* Shadows + blur: always full opacity, instant switch */}
        {frame === 0 && (
          <g>
            <path d="M58.6256 30.182C61.7476 24.5247 69.8788 24.5247 73.0008 30.182L117.234 110.336C120.253 115.807 116.295 122.511 110.046 122.511H21.5804C15.3312 122.511 11.3734 115.807 14.3928 110.336L58.6256 30.182Z" fill="#B98E3E" />
            <foreignObject x={0.166} y={-3.895} width={130} height={130}>
              <div style={{ backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", clipPath: `url(#${uid}_triBlur)`, height: "100%", width: "100%" }} />
            </foreignObject>
          </g>
        )}
        {frame === 1 && (
          <g>
            ...
            <foreignObject x={1.397} y={-5.171} width={130} height={130}>
              <div style={{ backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", clipPath: `url(#${uid}_circBlur)`, height: "100%", width: "100%" }} />
            </foreignObject>
          </g>
        )}
        {frame === 2 && (
          <g>
            <path d="M19.2559 14.5478C19.2559 12.2152 20.8645 10.1907 23.1368 9.66365L63.6654 0.262787C64.4108 0.0898911 65.1858 0.0898908 65.9312 0.262787L106.46 9.66365C108.732 10.1907 110.341 12.2152 110.341 14.5478V57.252C110.341 69.4583 104.301 80.8738 94.2087 87.7403L66.4578 106.622C65.4564 107.304 64.1402 107.304 63.1387 106.622L35.3879 87.7403C25.296 80.8738 19.2559 69.4583 19.2559 57.252V14.5478Z" fill="#9A9761" />
            <foreignObject x={5.629} y={-0.117} width={110} height={130}>
              <div style={{ backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", clipPath: `url(#${uid}_shieldBlur)`, height: "100%", width: "100%" }} />
            </foreignObject>
          </g>
        )}

        {/* Overlays + icons: smooth CSS crossfade */}
        <g style={{ opacity: frame === 0 ? 1 : 0, transition: "opacity 0.25s ease" }}>
          <path
            ...
            strokeWidth={0.747}
          />
          <path d="M65.4657 86.1422H66.2029V86.9142H65.4657V86.1422Z" stroke="white" strokeWidth={8.966} strokeLinecap="round" strokeLinejoin="round" />
          <path d="M65.8331 42.562V73.442" stroke="white" strokeWidth={8.966} strokeLinecap="round" strokeLinejoin="round" />
        </g>

        <g style={{ opacity: frame === 1 ? 1 : 0, transition: "opacity 0.25s ease" }}>
          <path
            ...
            strokeWidth={0.635}
          />
          <path d="M65.5 81.156C77.775 81.156 87.725 71.206 87.725 58.931C87.725 46.657 77.775 36.706 65.5 36.706C53.226 36.706 43.275 46.657 43.275 58.931C43.275 71.206 53.226 81.156 65.5 81.156Z" stroke="white" strokeWidth={7.62} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
          <path d="M50.066 43.498L80.934 74.366" stroke="white" strokeWidth={7.62} strokeLinecap="round" strokeLinejoin="round" />
        </g>

        <g style={{ opacity: frame === 2 ? 1 : 0, transition: "opacity 0.25s ease" }}>
          <path
            ...
            strokeWidth={0.806}
          />
          <path d="M49.0803 59.8898L59.7464 70.137L83.0783 47.7212" stroke="white" strokeWidth={6.449} strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </g>
    </svg>
  );
