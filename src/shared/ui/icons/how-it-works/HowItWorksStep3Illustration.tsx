...
export function HowItWorksStep3Illustration({
  ...
  const checkBlur = `${uid}_checkBlur`;
  const warnBlur = `${uid}_warnBlur`;
  const stopBlur = `${uid}_stopBlur`;
  ...
  return (
    ...
    >
      <defs>
        <clipPath id={checkBlur} transform="translate(-7.1651 -1.30438)">
        ...
        <clipPath id={warnBlur} transform="translate(6.73386 9.86374)">
          <path d="M57.9766 9.89502C61.2443 3.97364 69.7557 3.97365 73.0234 9.89502L121.334 97.438C124.494 103.165 120.352 110.182 113.811 110.182H17.1895C10.6484 110.182 6.50564 103.165 9.66602 97.438L57.9766 9.89502Z" />
        </clipPath>
        <clipPath id={stopBlur} transform="translate(5.62004 12.1888)">
          <path d="M65.4999 0.828613C97.589 0.828613 123.602 26.8421 123.602 58.9312C123.602 91.0203 97.589 117.034 65.4999 117.034C33.4108 117.034 7.39734 91.0203 7.39734 58.9312C7.39738 26.8421 33.4108 0.82865 65.4999 0.828613Z" />
        </clipPath>
        ...
        <AnimatePresence mode="wait">
          {frame === 0 && (
            ...
            >
              <path
                ...
                fill="#B98E3E"
              />
              <foreignObject x={-6.73386} y={-9.86374} width={144.468} height={135.364}>
                <div
                  {...({
                    xmlns: "http://www.w3.org/1999/xhtml",
                    style: {
                      backdropFilter: "blur(7.47px)",
                      WebkitBackdropFilter: "blur(7.47px)",
                      clipPath: `url(#${warnBlur})`,
                      height: "100%",
                      width: "100%",
                    },
              ...
              <path
                d="M57.9766 9.89502C61.2443 3.97364 69.7557 3.97365 73.0234 9.89502L121.334 97.438C124.494 103.165 120.352 110.182 113.811 110.182H17.1895C10.6484 110.182 6.50564 103.165 9.66602 97.438L57.9766 9.89502Z"
                fill={`url(#${uid}_warn0)`}
                fillOpacity={0.3}
          ...
          {frame === 1 && (
            ...
            >
              ...
              <foreignObject x={-5.62004} y={-12.1888} width={142.24} height={142.24}>
                <div
                  {...({
                    xmlns: "http://www.w3.org/1999/xhtml",
                    style: {
                      backdropFilter: "blur(6.35px)",
                      WebkitBackdropFilter: "blur(6.35px)",
                      clipPath: `url(#${stopBlur})`,
                      height: "100%",
                      width: "100%",
                    },
                  } as unknown as HTMLAttributes<HTMLDivElement>)}
              ...
              <path
                d="M65.4999 0.828613C97.589 0.828613 123.602 26.8421 123.602 58.9312C123.602 91.0203 97.589 117.034 65.4999 117.034C33.4108 117.034 7.39734 91.0203 7.39734 58.9312C7.39738 26.8421 33.4108 0.82865 65.4999 0.828613Z"
                fill={`url(#${uid}_stop0)`}
                fillOpacity={0.3}
          ...
          {frame === 2 && (
            ...
            >
              <path
                ...
                fill="#9A9761"
              />
              <foreignObject x={7.1651} y={1.30438} width={115.67} height={132.743}>
                <div
                  {...({
                    xmlns: "http://www.w3.org/1999/xhtml",
                    style: {
                      backdropFilter: "blur(4.03px)",
                      WebkitBackdropFilter: "blur(4.03px)",
                      clipPath: `url(#${checkBlur})`,
                      height: "100%",
                      width: "100%",
                    },
                  } as unknown as HTMLAttributes<HTMLDivElement>)}
